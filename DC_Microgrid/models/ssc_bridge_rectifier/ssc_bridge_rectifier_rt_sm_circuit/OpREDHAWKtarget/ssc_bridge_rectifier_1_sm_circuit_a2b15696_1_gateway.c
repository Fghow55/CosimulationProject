...
void ssc_bridge_rectifier_1_sm_circuit_a2b15696_1_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 1, 0.001, 0, 0, 0.0001, 0, 0,
    0, 0, (SscLoggingSetting) 0, 595175634, 0, };
  ...
  ssc_bridge_rectifier_1_sm_circuit_a2b15696_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group(
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,

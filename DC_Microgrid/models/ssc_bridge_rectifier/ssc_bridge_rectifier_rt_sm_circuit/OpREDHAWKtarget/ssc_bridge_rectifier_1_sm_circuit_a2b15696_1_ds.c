 ...
 */
/* ssc_bridge_rectifier_1_sm_circuit_a2b15696_1_ds.c - body for module ssc_bridge_rectifier_1_sm_circuit_a2b15696_1_ds */
...
static NeEquationData s_equation_data[5] = { { "", 0U, 8,
    NE_EQUATION_DOMAIN_TIME, "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/C",
    1U, 0U, TRUE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 1", 3U, 1U, TRUE, 1.0,
    "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 2", 3U, 4U, TRUE, 1.0,
    "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 3", 3U, 7U, TRUE, 1.0,
    "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 4", 3U, 10U, TRUE, 1.0,
    "1", } };
...
static NeVariableData s_variable_data[5] = { { "sm_circuit.C.vc", 0U, 0,
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/C", 1.0, "1", 0.0, TRUE, FALSE,
    1U, 1U, NE_INIT_MODE_MANDATORY, "Capacitor voltage", }, { "sm_circuit.C.p.v",
    0U, 1, "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/C", 1.0, "1", 0.0,
    FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Voltage", }, { "sm_circuit.C.i",
    0U, 0, "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/C", 1.0, "1", 0.0,
    FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Current", }, {
    "sm_circuit.Diode_2.i", 0U, 0,
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 2", 1.0, "1", 0.0, FALSE,
    FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Current", }, { "sm_circuit.Diode_4.i", 0U,
    0, "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 4", 1.0, "1", 0.0,
    FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Current", } };

static NeVariableData *s_discrete_data = NULL;
static NeObservableData s_observable_data[51] = { { "sm_circuit.C.i",
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/C", 1U, 1U, "A", 1.0e-6, "A",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, { "sm_circuit.C.n.v",
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/C", 1U, 1U, "V", 1.0e-6, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    ...
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/C", 1U, 1U, "kW", 1.0e-6, "kW",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "power_dissipated", }, {
    "sm_circuit.Diode_1.i",
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 1", 1U, 1U, "A", 1.0e-6,
    "A", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, { "sm_circuit.Diode_1.n.v",
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 1", 1U, 1U, "V", 1.0e-6,
    ...
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 1", 1U, 1U, "A*V",
    1.0e-6, "A*V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "power_dissipated", }, {
    "sm_circuit.Diode_2.i",
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 2", 1U, 1U, "A", 1.0e-6,
    "A", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, { "sm_circuit.Diode_2.n.v",
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 2", 1U, 1U, "V", 1.0e-6,
    "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    ...
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 2", 1U, 1U, "A*V",
    1.0e-6, "A*V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "power_dissipated", }, {
    "sm_circuit.Diode_3.i",
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 3", 1U, 1U, "A", 1.0e-6,
    "A", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, { "sm_circuit.Diode_3.n.v",
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 3", 1U, 1U, "V", 1.0e-6,
    "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    ...
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 3", 1U, 1U, "A*V",
    1.0e-6, "A*V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "power_dissipated", }, {
    "sm_circuit.Diode_4.i",
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 4", 1U, 1U, "A", 1.0e-6,
    "A", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, { "sm_circuit.Diode_4.n.v",
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 4", 1U, 1U, "V", 1.0e-6,
    "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    ...
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 4", 1U, 1U, "A*V",
    1.0e-6, "A*V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "power_dissipated", }, {
    "sm_circuit.Electrical_Reference.V.v",
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Electrical Reference", 1U, 1U,
    "V", 1.0e-6, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "sm_circuit.Electrical_Reference1.V.v",
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Electrical Reference1", 1U, 1U,
    "V", 1.0e-6, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "sm_circuit.Ideal_Transformer.i1",
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Ideal Transformer", 1U, 1U,
  ...
  { "sm_circuit.Vac.i", "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Vac", 1U,
    1U, "A", 1.0e-6, "A", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i", }, { "sm_circuit.Vac.n.v",
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Vac", 1U, 1U, "V", 1.0e-6, "V",
    ...
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Voltage Sensor", 1U, 1U, "V",
    ...
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/PS-Simulink\nConverter", 1U,
    1U, "V", 1.0e-6, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
...
static NeZCData s_zc_data[4] = { {
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 1", 1U, 0U,
    "sm_circuit.Diode_1",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/pwl_diode.ssc",
    NE_ZC_TYPE_FALSE, }, {
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 2", 1U, 1U,
    "sm_circuit.Diode_2",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/pwl_diode.ssc",
    NE_ZC_TYPE_FALSE, }, {
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 3", 1U, 2U,
    "sm_circuit.Diode_3",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/pwl_diode.ssc",
    NE_ZC_TYPE_FALSE, }, {
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 4", 1U, 3U,
    "sm_circuit.Diode_4",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/pwl_diode.ssc",
    NE_ZC_TYPE_FALSE, } };
...
static NeAssertData s_assert_data[10] = { {
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/C", 1U, 0U,
    "sm_circuit.C.power_dissipated",
    ...
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/C", 1U, 1U,
    "sm_circuit.C.power_dissipated",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/capacitor.ssc",
    FALSE,
    ...
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/C", 1U, 2U,
    "sm_circuit.C.power_dissipated",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/capacitor.ssc",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/C", 1U, 3U,
    "sm_circuit.C.power_dissipated",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/capacitor.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Load", 1U, 4U,
    "sm_circuit.Load.power_dissipated",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/resistor.ssc",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Load", 1U, 5U,
    "sm_circuit.Load.power_dissipated",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/resistor.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 1", 1U, 6U,
    "sm_circuit.Diode_1",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/pwl_diode.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 2", 1U, 7U,
    "sm_circuit.Diode_2",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/pwl_diode.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 3", 1U, 8U,
    "sm_circuit.Diode_3",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/pwl_diode.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/Diode 4", 1U, 9U,
    "sm_circuit.Diode_4",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/pwl_diode.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", } };
...
static NeParameterData s_real_parameter_data[1] = { { "RTP_983F50E8_vc",
    "ssc_bridge_rectifier_1_sm_circuit/sm_circuit/C", "", 0U, 1U, TRUE, } };
...
NeDynamicSystem *ssc_bridge_rectifier_1_sm_circuit_a2b15696_1_dae_ds(PmAllocator
  *allocator)
{
  NeDynamicSystem *ds;
  _NeDynamicSystem *_ds;
  ...
  ds->mMethods[NE_DS_METHOD_F] =
    ssc_bridge_rectifier_1_sm_circuit_a2b15696_1_ds_f;
  ...
  ds->mMethods[NE_DS_METHOD_DXF] =
    ssc_bridge_rectifier_1_sm_circuit_a2b15696_1_ds_dxf;
  ...
  ds->mMethods[NE_DS_METHOD_LOG] =
    ssc_bridge_rectifier_1_sm_circuit_a2b15696_1_ds_log;

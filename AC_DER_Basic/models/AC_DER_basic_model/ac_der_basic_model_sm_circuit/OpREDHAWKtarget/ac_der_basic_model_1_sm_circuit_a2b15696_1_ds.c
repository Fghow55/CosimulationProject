 ...
 */
/* ac_der_basic_model_1_sm_circuit_a2b15696_1_ds.c - body for module ac_der_basic_model_1_sm_circuit_a2b15696_1_ds */

#include "ne_ds.h"
#include "ac_der_basic_model_1_sm_circuit_a2b15696_1_ds_obs_il.h"
#include "ac_der_basic_model_1_sm_circuit_a2b15696_1_ds_obs_all.h"
...
#include "ac_der_basic_model_1_sm_circuit_a2b15696_1_ds_log.h"
#include "ac_der_basic_model_1_sm_circuit_a2b15696_1_ds_dxf.h"
#include "ac_der_basic_model_1_sm_circuit_a2b15696_1_ds_f.h"
...
static NeEquationData s_equation_data[5] = { { "", 0U, 8,
    NE_EQUATION_DOMAIN_TIME, "ac_der_basic_model_1_sm_circuit/sm_circuit/C", 1U,
    0U, TRUE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 1", 3U, 1U, TRUE, 1.0, "1",
  }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 2", 3U, 4U, TRUE, 1.0, "1",
  }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 3", 3U, 7U, TRUE, 1.0, "1",
  }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 4", 3U, 10U, TRUE, 1.0,
    "1", } };

static NeCERData *s_cer_data = NULL;
static NeICRData *s_icr_data = NULL;
static NeVariableData s_variable_data[5] = { { "sm_circuit.C.vc", 0U, 0,
    "ac_der_basic_model_1_sm_circuit/sm_circuit/C", 1.0, "1", 0.0, TRUE, FALSE,
    1U, 1U, NE_INIT_MODE_MANDATORY, "Capacitor voltage", }, { "sm_circuit.C.p.v",
    0U, 1, "ac_der_basic_model_1_sm_circuit/sm_circuit/C", 1.0, "1", 0.0, FALSE,
    FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Voltage", }, { "sm_circuit.C.i", 0U, 0,
    "ac_der_basic_model_1_sm_circuit/sm_circuit/C", 1.0, "1", 0.0, FALSE, FALSE,
    1U, 1U, NE_INIT_MODE_NONE, "Current", }, { "sm_circuit.Diode_2.i", 0U, 0,
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 2", 1.0, "1", 0.0, FALSE,
    FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Current", }, { "sm_circuit.Diode_4.i", 0U,
    0, "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 4", 1.0, "1", 0.0,
    FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Current", } };

static NeVariableData *s_discrete_data = NULL;
static NeObservableData s_observable_data[51] = { { "sm_circuit.C.i",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/C", 1U, 1U, "A", 1.0e-6, "A",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, { "sm_circuit.C.n.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/C", 1U, 1U, "V", 1.0e-6, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "sm_circuit.C.p.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/C", 1U, 1U, "V", 1.0e-6, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "sm_circuit.C.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/C", 1U, 1U, "V", 1.0e-6, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "sm_circuit.C.vc",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/C", 1U, 1U, "V", 1.0e-6, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_MANDATORY, FALSE, TRUE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Capacitor voltage", }, {
    "sm_circuit.C.power_dissipated",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/C", 1U, 1U, "kW", 1.0e-6, "kW",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "power_dissipated", }, {
    "sm_circuit.Diode_1.i", "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 1",
    1U, 1U, "A", 1.0e-6, "A", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, {
    "sm_circuit.Diode_1.n.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 1", 1U, 1U, "V", 1.0e-6,
    "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "sm_circuit.Diode_1.p.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 1", 1U, 1U, "V", 1.0e-6,
    "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "sm_circuit.Diode_1.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 1", 1U, 1U, "V", 1.0e-6,
    "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "sm_circuit.Diode_1.power_dissipated",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 1", 1U, 1U, "A*V", 1.0e-6,
    "A*V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "power_dissipated", }, {
    "sm_circuit.Diode_2.i", "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 2",
    1U, 1U, "A", 1.0e-6, "A", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, {
    "sm_circuit.Diode_2.n.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 2", 1U, 1U, "V", 1.0e-6,
    "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "sm_circuit.Diode_2.p.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 2", 1U, 1U, "V", 1.0e-6,
    "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "sm_circuit.Diode_2.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 2", 1U, 1U, "V", 1.0e-6,
    "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "sm_circuit.Diode_2.power_dissipated",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 2", 1U, 1U, "A*V", 1.0e-6,
    "A*V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "power_dissipated", }, {
    "sm_circuit.Diode_3.i", "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 3",
    1U, 1U, "A", 1.0e-6, "A", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, {
    "sm_circuit.Diode_3.n.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 3", 1U, 1U, "V", 1.0e-6,
    "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "sm_circuit.Diode_3.p.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 3", 1U, 1U, "V", 1.0e-6,
    "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "sm_circuit.Diode_3.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 3", 1U, 1U, "V", 1.0e-6,
    "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "sm_circuit.Diode_3.power_dissipated",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 3", 1U, 1U, "A*V", 1.0e-6,
    "A*V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "power_dissipated", }, {
    "sm_circuit.Diode_4.i", "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 4",
    1U, 1U, "A", 1.0e-6, "A", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, {
    "sm_circuit.Diode_4.n.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 4", 1U, 1U, "V", 1.0e-6,
    "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "sm_circuit.Diode_4.p.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 4", 1U, 1U, "V", 1.0e-6,
    "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "sm_circuit.Diode_4.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 4", 1U, 1U, "V", 1.0e-6,
    "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "sm_circuit.Diode_4.power_dissipated",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 4", 1U, 1U, "A*V", 1.0e-6,
    "A*V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "power_dissipated", }, {
    "sm_circuit.Electrical_Reference.V.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Electrical Reference", 1U, 1U,
    "V", 1.0e-6, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "sm_circuit.Electrical_Reference1.V.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Electrical Reference1", 1U, 1U,
    "V", 1.0e-6, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "sm_circuit.Ideal_Transformer.i1",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Ideal Transformer", 1U, 1U, "A",
    1.0e-6, "A", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Primary current", }, {
    "sm_circuit.Ideal_Transformer.i2",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Ideal Transformer", 1U, 1U, "A",
    1.0e-6, "A", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Secondary current", }, {
    "sm_circuit.Ideal_Transformer.n1.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Ideal Transformer", 1U, 1U, "V",
    1.0e-6, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "sm_circuit.Ideal_Transformer.n2.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Ideal Transformer", 1U, 1U, "V",
    1.0e-6, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "sm_circuit.Ideal_Transformer.p1.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Ideal Transformer", 1U, 1U, "V",
    1.0e-6, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "sm_circuit.Ideal_Transformer.p2.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Ideal Transformer", 1U, 1U, "V",
    1.0e-6, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "sm_circuit.Ideal_Transformer.v1",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Ideal Transformer", 1U, 1U, "V",
    1.0e-6, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Primary voltage", }, {
    "sm_circuit.Ideal_Transformer.v2",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Ideal Transformer", 1U, 1U, "V",
    1.0e-6, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Secondary voltage", }, {
    "sm_circuit.Load.i", "ac_der_basic_model_1_sm_circuit/sm_circuit/Load", 1U,
    1U, "A", 1.0e-6, "A", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current", }, {
    "sm_circuit.Load.n.v", "ac_der_basic_model_1_sm_circuit/sm_circuit/Load", 1U,
    1U, "V", 1.0e-6, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "sm_circuit.Load.p.v", "ac_der_basic_model_1_sm_circuit/sm_circuit/Load", 1U,
    1U, "V", 1.0e-6, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "sm_circuit.Load.v", "ac_der_basic_model_1_sm_circuit/sm_circuit/Load", 1U,
    1U, "V", 1.0e-6, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "sm_circuit.Load.power_dissipated",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Load", 1U, 1U, "A^2*Ohm", 1.0e-6,
    "A^2*Ohm", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, FALSE, "power_dissipated", }, {
    "sm_circuit.Simulink_PS_Converter_output",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Simulink-PS\nConverter", 1U, 1U,
    ...
    "sm_circuit.Vac.i", "ac_der_basic_model_1_sm_circuit/sm_circuit/Vac", 1U, 1U,
    "A", 1.0e-6, "A", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "i", }, { "sm_circuit.Vac.n.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Vac", 1U, 1U, "V", 1.0e-6, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "sm_circuit.Vac.p.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Vac", 1U, 1U, "V", 1.0e-6, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, { "sm_circuit.Vac.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Vac", 1U, 1U, "V", 1.0e-6, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "v", }, { "sm_circuit.Vac.vT",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Vac", 1U, 1U, "V", 1.0e-6, "V",
    NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "vT", }, { "sm_circuit.Voltage_Sensor.V",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Voltage Sensor", 1U, 1U, "V",
    1.0e-6, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "V", }, { "sm_circuit.Voltage_Sensor.n.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Voltage Sensor", 1U, 1U, "V",
    1.0e-6, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "sm_circuit.Voltage_Sensor.p.v",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Voltage Sensor", 1U, 1U, "V",
    1.0e-6, "V", NE_NOMINAL_SOURCE_NONE, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "sm_circuit.Voltage_Sensor_V",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/PS-Simulink\nConverter", 1U, 1U,
...
static NeZCData s_zc_data[4] = { {
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 1", 1U, 0U,
    "sm_circuit.Diode_1",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/pwl_diode.ssc",
    NE_ZC_TYPE_FALSE, }, { "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 2",
    1U, 1U, "sm_circuit.Diode_2",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/pwl_diode.ssc",
    NE_ZC_TYPE_FALSE, }, { "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 3",
    1U, 2U, "sm_circuit.Diode_3",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/pwl_diode.ssc",
    NE_ZC_TYPE_FALSE, }, { "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 4",
    1U, 3U, "sm_circuit.Diode_4",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/pwl_diode.ssc",
    NE_ZC_TYPE_FALSE, } };
...
static NeAssertData s_assert_data[10] = { {
    "ac_der_basic_model_1_sm_circuit/sm_circuit/C", 1U, 0U,
    "sm_circuit.C.power_dissipated",
    ...
    "ac_der_basic_model_1_sm_circuit/sm_circuit/C", 1U, 1U,
    "sm_circuit.C.power_dissipated",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/capacitor.ssc",
    FALSE,
    ...
    "ac_der_basic_model_1_sm_circuit/sm_circuit/C", 1U, 2U,
    "sm_circuit.C.power_dissipated",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/capacitor.ssc",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "ac_der_basic_model_1_sm_circuit/sm_circuit/C", 1U, 3U,
    "sm_circuit.C.power_dissipated",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/capacitor.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Load", 1U, 4U,
    "sm_circuit.Load.power_dissipated",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/resistor.ssc",
    FALSE,
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Load", 1U, 5U,
    "sm_circuit.Load.power_dissipated",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/resistor.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 1", 1U, 6U,
    "sm_circuit.Diode_1",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/pwl_diode.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 2", 1U, 7U,
    "sm_circuit.Diode_2",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/pwl_diode.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 3", 1U, 8U,
    "sm_circuit.Diode_3",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/pwl_diode.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    "ac_der_basic_model_1_sm_circuit/sm_circuit/Diode 4", 1U, 9U,
    "sm_circuit.Diode_4",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/pwl_diode.ssc",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", } };

static NeRange s_assert_range[10] = { {
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+electrical/+elements/capacitor.ssc",
...
static NeParameterData s_real_parameter_data[1] = { { "RTP_983F50E8_vc",
    "ac_der_basic_model_1_sm_circuit/sm_circuit/C", "", 0U, 1U, TRUE, } };
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mA.mN = 2;
  out->mA.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 2);
  return out;
}
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mF.mN = 5;
  out->mF.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 5);
  return out;
}
  ...
  allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mDXF_P.mNumCol = 5;
  out->mDXF_P.mNumRow = 5;
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mTDXF_P.mNumCol = 5;
  out->mTDXF_P.mNumRow = 5;
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mIC.mN = 5;
  out->mIC.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 5);
  return out;
}
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mIMIN.mN = 5;
  out->mIMIN.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 5);
  return out;
}
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mIMAX.mN = 5;
  out->mIMAX.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 5);
  return out;
}
...
NeDynamicSystem *ac_der_basic_model_1_sm_circuit_a2b15696_1_dae_ds(PmAllocator
  *allocator)
{
  NeDynamicSystem *ds;
  _NeDynamicSystem *_ds;
  ...
  ds->mNumRealCache = 0;
  ds->mNumIntCache = 0;
  ds->mNumObservables = 51;
  ds->mNumObservableElements = 45;
  ds->mNumZcs = 4;
  ds->mNumAsserts = 10;
  ...
  input_info[0].mIdentifier = "sm_circuit.Simulink_PS_Converter_output";
  input_info[0].mM = 1;
  input_info[0].mN = 1;
  input_info[0].mName = "sm_circuit.Simulink_PS_Converter_output";
  input_info[0].mUnit = "1";
  ds->mIo[NE_INPUT_IO_TYPE] = input_info;
  ds->mNumIo[NE_OUTPUT_IO_TYPE] = 1;
  output_info[0].mIdentifier = "sm_circuit.Voltage_Sensor_V";
  output_info[0].mM = 1;
  output_info[0].mN = 1;
  output_info[0].mName = "sm_circuit.Voltage_Sensor_V";
  ...
  ds->mMethods[NE_DS_METHOD_F] = ac_der_basic_model_1_sm_circuit_a2b15696_1_ds_f;
  ...
  ds->mMethods[NE_DS_METHOD_DXF] =
    ac_der_basic_model_1_sm_circuit_a2b15696_1_ds_dxf;
  ...
  ds->mMethods[NE_DS_METHOD_LOG] =
    ac_der_basic_model_1_sm_circuit_a2b15696_1_ds_log;
  ...
  *t3, NeDsMethodOutput *t4)
{
  ...
  out = t4->mDUF;
  if (M_idx_0 != 0) {
    t0 = -0.23809523809523808;
  } else {
    t0 = -7.142857142857143E-10;
  }

  if (M_idx_2 != 0) {
    t1 = 0.23809523809523808;
  } else {
    t1 = 7.142857142857143E-10;
  }
  ...
  *t1, NeDsMethodOutput *t2)
{
  ...
  X_idx_2 = t1->mX.mX[2];
  out = t2->mMODE;
  out.mX[0] = (int32_T)(-X_idx_1 + U_idx_0 * 0.071428571428571425 > 0.6);
  out.mX[1] = (int32_T)(-X_idx_1 > 0.6);
  out.mX[2] = (int32_T)(((-X_idx_0 + X_idx_2 * -1.0E-6) + U_idx_0 *
    -0.071428571428571425) + X_idx_1 > 0.6);
  out.mX[3] = (int32_T)((-X_idx_0 + X_idx_2 * -1.0E-6) + X_idx_1 > 0.6);
  (void)sys;
  (void)t2;
  return 0;
}
                     ...
                     NeDsMethodOutput *t3)
{
  ...
  X_idx_2 = t2->mX.mX[2];
  out = t3->mY;
  out.mX[0] = X_idx_1 - ((-X_idx_0 + X_idx_2 * -1.0E-6) + X_idx_1);
  (void)sys;
  (void)t3;
  return 0;
}
                      ...
                      NeDsMethodOutput *t2)
{
  ...
  X_idx_2 = t1->mX.mX[2];
  out = t2->mZC;
  out.mX[0] = (-X_idx_1 + U_idx_0 * 0.071428571428571425) - 0.6;
  out.mX[1] = -X_idx_1 - 0.6;
  out.mX[2] = (((-X_idx_0 + X_idx_2 * -1.0E-6) + U_idx_0 * -0.071428571428571425)
               + X_idx_1) - 0.6;
  out.mX[3] = ((-X_idx_0 + X_idx_2 * -1.0E-6) + X_idx_1) - 0.6;
  (void)sys;
  (void)t2;
  return 0;
}
